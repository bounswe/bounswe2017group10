...
public class NearbyItemsFragment extends Fragment {
    ...
    public interface RequestStrategy {
         ...
         */
        public void requestItems(Context context, int offset, OnGetItemsResponse.GetItemCallback getItemCallback,double latitude,double longitude);
    }
    ...
    public static class FeedStrategy implements RequestStrategy {
        @Override
        public void requestItems(Context context, int offset, OnGetItemsResponse.GetItemCallback getItemCallback,double latitude,double longitute) {
            ...
            APIUtils.serverAPI().getNearbyItems(authStr, Constants.PAGINATION_COUNT, offset,latitude,longitute).enqueue(respHandler);
        }
    }
    ...
    public void loadMoreItems() {
        ...
        this.isLoading = true;
        this.requestStrategy.requestItems(getActivity(), this.currentOffset, mGetItemCallback, latitude,longitude);
