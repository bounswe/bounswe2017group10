...
urlpatterns = [
    ...
    url(r'^cultural_heritage_item/search/(?P<query>[\w\W]+)/?$', views.cultural_heritage_item_search.as_view()),
    url(r'^cultural_heritage_item/search_autocorrect/(?P<query>[\w\W]+)/?$',
