...
const Show = ({ user, token, culturalHeritage, commentInput, recommendations, recommendationLoadCompleted, commentInputChange, postComment, favoriteItem, removeClick, annotations, showAnnotation, hideAnnotation, annotationInput, updateAnnotationInput, createAnnotation }) => (
