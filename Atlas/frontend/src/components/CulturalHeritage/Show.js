...
const Show = ({ user, token, culturalHeritage, commentInput, recommendations, recommendationLoadCompleted, commentInputChange, postComment, favoriteItem, removeClick, annotations, showAnnotation, hideAnnotation }) => (
  culturalHeritage !== undefined &&
    <Container>
      ...
      <Row>
        <Col xs="9">
          <CulturalHeritage culturalHeritage={ culturalHeritage } shouldTruncate={ false } showComments={ true } favorite={ () => favoriteItem(token, culturalHeritage) } withLink={ false } showAnnotations={ true } annotations={ annotations } showAnnotation={ showAnnotation } hideAnnotation={ hideAnnotation }/>
